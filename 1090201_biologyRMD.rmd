...
1.阿摩筆記<https://img.yamol.tw/file/5ffaec55411d2.jpg>


2.余民寧。105年4月1日。學生問題表分析<https://nccur.lib.nccu.edu.tw/bitstream/140.119/110205/1/217.pdf>。國家文官學院 T&D飛訊第217期，第1-25頁。


3.趙本強。102年3月20日。學習評量與 SP 表分析<https://tle.cycu.edu.tw/actSignFile.do?file=ef6455f4-060c-427d-b446-e5c16d9e7611&fileType=file>。中原大學特殊教育系。
...
for (i in 1:max(class)){
  ...
  text(x=0.1,y=80,labels="A學習穩定",cex=1,col='grey')
  text(x=0.1,y=60,labels="B努力不足",cex=1,col='grey')
  text(x=0.1,y=40,labels="C學力不足",cex=1,col='grey')
  text(x=1.45,y=80,labels="A'粗心大意",cex=1,col='grey')
  text(x=1.45,y=60,labels="B'準備不足",cex=1,col='grey')
  text(x=1.45,y=40,labels="C'學習異常",cex=1,col='grey')
